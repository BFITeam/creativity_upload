...
egen mean_1 = mean(score) if (round==1 & treatment_id==11)
egen mean_2 = mean(score) if (round==2 & treatment_id==11)
egen mean_3 = mean(score) if (round==3 & treatment_id==11)
...
egen mean_1 = mean(score) if (round==1 & treatment_id==12)
egen mean_2 = mean(score) if (round==2 & treatment_id==12)
egen mean_3 = mean(score) if (round==3 & treatment_id==12)
...
egen mean_1 = mean(score) if (round==1 & treatment_id==13)
egen mean_2 = mean(score) if (round==2 & treatment_id==13)
egen mean_3 = mean(score) if (round==3 & treatment_id==13)
...
egen mean_1 = mean(score) if (round==1 & treatment_id==14)
egen mean_2 = mean(score) if (round==2 & treatment_id==14)
egen mean_3 = mean(score) if (round==3 & treatment_id==14)
...
graph export "$mypath\Figures\Figure 2\Figure2a_score.ps", logo(off) replace
