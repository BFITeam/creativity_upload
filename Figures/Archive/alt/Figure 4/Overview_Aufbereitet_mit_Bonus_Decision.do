...
global mypath = "I:\personal\zew_interns\p-schmit\WOEK\Final Paper Versions\Figures\Figure 4"

use "$mypath\Overview.dta", clear
log using "$mypath\20150429_Overview_Aufbereitet.log", replace
...
*************************************************************************************************
* Ausschließen falls Arbeitgeber, Problemkandidat oder Problemsession
drop if proposer ==1
drop if fdb_old == 1
drop if no_problem !=.
drop if !missing(session_problem)
